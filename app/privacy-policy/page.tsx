    ...
    <BgContainer>
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto py-6">
          ...
          <div className="bg-white -lg shadow-sm border border-[#fa752d]/20 p-6 md:p-8 lg:p-10">
            ...
            <div className="prose max-w-none space-y-6 md:space-y-8">
              ...
              <section>
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                  Welcome to Auditly360. We are committed to protecting your
                  privacy and ensuring the security of your personal
                  information. This Privacy Policy explains how we collect, use,
                  disclose, and safeguard your information when you use our
                  website auditing platform and services.
                </p>
              </section>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-sm md:text-base text-gray-700 ml-4">
                      ...
                      <li>
                        Payment information processed through Razorpay (we do
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-sm md:text-base text-gray-700 ml-4">
                      ...
                      <li>
                        Project configurations and custom audit instructions
                      </li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-sm md:text-base text-gray-700 ml-4">
                  <li>
                    Provide, maintain, and improve our website auditing services
                  </li>
                  <li>
                    Process your subscription payments and manage your account
                  </li>
                  <li>
                    Perform website audits, crawls, and analysis as requested
                  </li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-sm md:text-base text-gray-700 ml-4">
                  <li>
                    ...
                    address are stored as long as your account is active
                  </li>
                  <li>
                    <strong>Audit Data:</strong> Your audit results and project
                    data are stored until you choose to delete them
                  </li>
                  <li>
                    <strong>Account Information:</strong> Retained while your
                    account is active and for a reasonable period after account
                    closure
                  </li>
                </ul>
                <p className="text-sm md:text-base text-gray-700 leading-relaxed mt-3">
                  You can delete your audit data and projects at any time
                  through your account dashboard. Upon account deletion, we will
                  remove your personal information, except where we are required
                  to retain it for legal, accounting, or regulatory purposes.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-sm md:text-base text-gray-700 ml-4">
                  <li>
                    ...
                    process subscription payments. Razorpay handles payment
                    information according to their privacy policy. We do not
              ...
              <section>
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                  ...
                  measures to protect your personal information and audit data
                  against unauthorized access, alteration, disclosure, or
                  destruction. This includes encryption, secure access controls,
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-sm md:text-base text-gray-700 ml-4">
                  <li>
                    <strong>Access:</strong> View and access your personal
                    information and audit data through your account
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Delete:</strong> Delete your audit data and projects
                    at any time
                  </li>
                  <li>
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed mt-3">
                  ...
                  contact page or your account settings.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                  Our service is available to users of all ages. We do not
                  ...
                  please contact us to have that information removed.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                  ...
                  the &quot;Last Updated&quot; date. Your continued use of our
                  service after such changes constitutes acceptance of the
