...
export default function SiteCrawlForm({
  ...
  const handleBrandDataChange = (
    field: keyof BrandConsistencyData,
    value: string
  ): void => {
    setBrandData((prev) => ({
      ...prev,
  ...
  if (planLoading) {
    return (
      <motion.div
        className="bg-white p-4 sm:p-6  overflow-hidden h-full flex flex-col"
        initial={{
          opacity: 0,
          y: 20,
        }}
      ...
      >
        {!isEditMode && (
          <div className="mb-6">
            <div className="h-6 bg-gray-200  w-32 animate-pulse"></div>
          </div>
        )}
        ...
        <div className="">
          <div className="space-y-6">
            {/* URL Input Skeleton */}
            <div>
              <div className="h-11 bg-gray-200  animate-pulse"></div>
            </div>
            ...
            <div className=" -lg p-4 sm:p-6 space-y-4 border border-[#ff4b01]/20">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  <div className="h-3 bg-gray-200  w-24 mb-2 animate-pulse"></div>
                  <div className="h-10 bg-gray-200 -lg animate-pulse"></div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <div className="h-3 bg-gray-200  w-20 mb-2 animate-pulse"></div>
                    <div className="h-10 bg-gray-200 -lg animate-pulse"></div>
                  </div>
                  <div>
                    <div className="h-3 bg-gray-200  w-24 mb-2 animate-pulse"></div>
                ...
                <div>
                  <div className="h-3 bg-gray-200  w-16 mb-2 animate-pulse"></div>
                  <div className="h-10 bg-gray-200 -lg animate-pulse"></div>
                </div>
                <div>
                  <div className="h-3 bg-gray-200  w-32 mb-2 animate-pulse"></div>
                  <div className="h-20 bg-gray-200 -lg animate-pulse"></div>
                </div>
              </div>
            </div>
  ...
  if (!planInfo) {
    return (
      <motion.div
        className="bg-white p-4 sm:p-6  border-gray-300 overflow-hidden h-full flex flex-col"
        initial={{
          opacity: 0,
          y: 20,
        }}
  ...
  return (
    <motion.div
      className="bg-white p-4 sm:p-6 border-r border-gray-300 overflow-hidden h-full flex flex-col"
      initial={{
        opacity: 0,
        y: 20,
      }}
      ...
      {!isEditMode && (
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 mt-2">
            Simply paste your website URL into the audit tool and configure your
            crawl settings.
            <br />
            Our system will scan your website for SEO, performance, security,
        ...
        >
          <div className="flex-1 space-y-6">
            ...
            <div>
              <input
                ...
                className="w-full px-4 py-4 border border-gray-300 -lg text-black focus:outline-none focus:border-[#ff4b01] transition-colors"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-2">
                <label
                  className={`flex items-center p-3 border -lg cursor-pointer transition-colors ${
                    pageType === "single"
                      ? "border-[#ff4b01] bg-[#ff4b01]/5"
                ...
                >
                  ...
                  <div className="flex items-center">
                    <div
                      className={`w-4 h-4 -full border-2 mr-3 ${
                        pageType === "single"
                          ? "border-[#ff4b01] bg-[#ff4b01]"
                          : "border-gray-300"
                      }`}
                    >
                      {pageType === "single" && (
                        <div className="w-2 h-2 bg-white -full m-0.5"></div>
                      )}
                    </div>
                    <div>
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      hasFeature("full_site_crawl") &&
                      setPageType(e.target.value as CrawlType)
                    }
              ...
              <label className="flex items-center p-3 border border-gray-300 -lg cursor-pointer hover:border-gray-300 transition-colors">
                <input
                  ...
                  className="h-4 w-4 text-[#ff4b01] border-gray-300  focus:outline-none"
                />
            ...
            {brandConsistency && (
              <div className="p-4 sm:p-6 space-y-4 border border-[#ff4b01]/20 ">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="relative group cursor-default">
                      ...
                      <div className="pointer-events-none absolute left-0 top-7 z-20 w-64 rounded-md border border-gray-200 bg-white px-3 py-2 text-xs text-gray-700 shadow-lg opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-150">
                        We scan your website pages for these brand details and
                        flag missing information, inconsistencies, or obvious
                        typos so your company data stays accurate everywhere.
                      </div>
                    </div>
                  </div>
                </div>
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleBrandDataChange("companyName", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-300 -lg text-black focus:outline-none focus:border-[#ff4b01] transition-colors"
                    />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleBrandDataChange("phoneNumber", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-gray-300 -lg text-black focus:outline-none focus:border-[#ff4b01] transition-colors"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleBrandDataChange("emailAddress", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-gray-300 -lg text-black focus:outline-none focus:border-[#ff4b01] transition-colors"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleBrandDataChange("address", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-gray-300 -lg text-black focus:outline-none focus:border-[#ff4b01] transition-colors"
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleBrandDataChange(
                          "additionalInformation",
                          e.target.value
                        )
                      }
                      rows={3}
                      className="w-full px-3 py-2 text-black border border-gray-300 -lg focus:outline-none focus:border-[#ff4b01] transition-colors"
                    />
                  </div>
                </div>
              </div>
            ...
            {/* Hidden URLs Fields */}
            {hiddenUrls && (
              <div className="bg-gray-50 -lg p-4 space-y-4 border border-gray-300">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center px-4 py-2 border-2 border-[#ff4b01] text-[#ff4b01] bg-transparent -lg hover:bg-[#ff4b01]/10 transition-colors cursor-pointer"
                  >
                    <svg
                  ...
                  {hiddenUrlsList.map((hiddenUrl) => (
                    ...
                    >
                      <input
                        ...
                        value={hiddenUrl.url}
                        onChange={(e) =>
                          updateHiddenUrl(hiddenUrl.id, e.target.value)
                        }
                        placeholder="https://example.com/hidden-page"
                        className="flex-1 px-3 py-2 text-black border border-gray-300 -lg focus:outline-none focus:border-[#ff4b01] transition-colors"
                      />
            ...
            <div className="bg-gray-50 -lg p-4 border border-gray-300">
              <div className="flex items-center justify-between">
                ...
                <div className={`px-2 py-1 -full text-xs font-medium ${
          ...
          <div className="pt-2">
            <button
              ...
              className={`w-full py-3 px-4  focus:outline-none font-medium transition-all ${
                !canCreateNewProject
                  ...
                  : isSubmitting
                  ? "border-2 border-gray-300 text-gray-400 cursor-not-allowed"
                  : "border-2 border-[#ff4b01] text-[#ff4b01] bg-transparent hover:bg-[#ff4b01]/10 hover:border-[#ff4b01]"
              }`}
            >
