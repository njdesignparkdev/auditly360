        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="cursor-pointer px-4 py-2 bg-gray-600 text-white -lg hover:bg-gray-700 transition-colors flex items-center gap-2"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-end gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={isSaving}
              className="px-4 py-2 bg-blue-600 cursor-pointer text-white -lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
            >
              {isSaving ? (
                <>
