...
export default function HeroSection() {
  ...
  return (
    <div className='relative ' style={{ backgroundColor: '#0B1421' }}>
      <div className='min-h-[70vh] md:min-h-screen px-4 relative overflow-hidden ' >
        ...
        {/* Content Layer */}
        <div className="relative flex flex-col text-white z-10 md:min-h-screen pt-32 md:pt-48 ">
          <div className="content mx-auto text-center  ">
            ...
            <div className="content-text mt-4 md:mt-6  text-center flex flex-col items-center justify-center gap-4 md:gap-8 ">
      ...
      <div className="iamges mx-4 md:mx-auto -mt-12 md:-mt-46 lg:-mt-52 xl:-mt-60 max-w-[90rem] bg-[#D9D9D9] rounded-t-lg px-6 md:px-8 lg:px-10 pt-6 md:pt-8 lg:pt-10 relative z-[60] lg:block">
        <Image src='/images/home-page/hero-sec.png' alt='hero-image' width={5000} height={5000} className='rounded-t-lg w-full' />
      </div>
    </div>
  )
}
