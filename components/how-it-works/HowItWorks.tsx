              ...
              <div className="flex-1 space-y-2.5">
                 ...
                 <div className="space-y-1">
                    ...
                    <div className="h-1.5 w-full bg-slate-100 rounded-none overflow-hidden">
                       <motion.div initial={{ width: 0 }} animate={{ width: "30%" }} transition={{ delay: 0.5, duration: 1 }} className="h-full bg-red-500 rounded-none" />
                    </div>
                 </div>
                 {/* Warnings */}
                 <div className="space-y-1">
                    ...
                    <div className="h-1.5 w-full bg-slate-100 rounded-none overflow-hidden">
                       <motion.div initial={{ width: 0 }} animate={{ width: "20%" }} transition={{ delay: 0.7, duration: 1 }} className="h-full bg-yellow-500 rounded-none" />
                    </div>
                 </div>
                 {/* Passed */}
                 <div className="space-y-1">
                    ...
                    <div className="h-1.5 w-full bg-slate-100 rounded-none overflow-hidden">
                       <motion.div initial={{ width: 0 }} animate={{ width: "80%" }} transition={{ delay: 0.9, duration: 1 }} className="h-full bg-green-500 rounded-none" />
                    </div>
                 </div>
              </div>
           </div>
            ...
            <div className="relative h-[320px] w-full bg-slate-50 rounded-none p-4 md:p-5 flex items-center justify-center overflow-hidden border border-slate-100 -inner">
                ...
                <div className="absolute bottom-8 flex gap-3">
                    {steps.map((_, idx) => (
                         <div 
                             key={idx} 
                             className={`h-2 rounded-none transition-all duration-500 ease-out ${currentStep === idx ? 'w-8 bg-orange-500' : 'w-2 bg-slate-300'}`}
                         />
                    ))}
                </div>
            </div>
