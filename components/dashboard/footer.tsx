    ...
    <footer className="w-full bg-white text-gray-600 py-6 px-6 mt-8 rounded-t-3xl border-t border-gray-100">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Link
                href="#"
                className="text-sm hover:text-[#ff4b01] transition-colors"
              >
                Auditly Audit
              </Link>
              <Link
            ...
            {/* Company Column */}
            <div className="flex flex-col gap-4">
              <h3 className="font-semibold lg:text-lg xl:text-xl text-gray-900 mb-2">
                Company
              </h3>
              <Link
                href="#"
              ...
              <Link
                href="#"
                className="text-sm lg:text-base hover:text-[#ff4b01] transition-colors"
              >
                Contact Us
              </Link>
            </div>
        ...
        <div className="text-xs text-gray-400 text-center leading-relaxed max-w-4xl mx-auto">
          Disclaimer: Auditly360 is not affiliated, associated, authorized,
          endorsed by, or in any way officially connected with Google,
          Microsoft, or any other third-party platforms mentioned. All product
